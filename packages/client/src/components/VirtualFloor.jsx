        ...
        <div className="corp-card mb-8 relative overflow-hidden bg-[#0A0D14] min-h-[900px] flex flex-col border border-white/5 shadow-2xl">
            ...
            <div className="relative z-10 flex-1 flex flex-col items-center justify-end pb-12 pt-8">
                ...
                <div className="w-[110%] h-8 mt-4 border-t-2 border-white/20 bg-gradient-to-b from-white/5 to-transparent rounded-t-[50%] opacity-50 relative">
                    <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLmomY29tL3N2ZyI+PHBhdGggZD0iTTAgMGwyMCAyME0yMCAwbC0yMCAyMCIgc3Ryb2tlPSJyZ2JhKDI1NSwyNTUsMjU1LDAuMDUpIiBzdHJva2Utd2lkdGg9IjEiLz48L3N2Zz4=')]"></div>
                </div>
            </div>
...
function RoomProps({ type }) {
    // Pure CSS props enriched with higher contrast for #0A0D14 background
    switch (type) {
        case 'ceo':
            return (
        ...
        case 'finance':
            return (
                <div className="absolute bottom-1 right-6 flex items-end gap-1.5 opacity-90 pointer-events-none">
                    ...
                    <div className="w-10 h-20 border border-emerald-500/50 bg-emerald-500/10 rounded-t-lg shadow-[0_0_15px_rgba(16,185,129,0.1)] flex items-center justify-center">
                        <div className="w-4 h-4 rounded-full border border-emerald-400/30"></div>
                    </div>
                </div>
            )
        case 'legal':
            return (
                <div className="absolute bottom-1 right-8 flex flex-col items-center opacity-90 pointer-events-none">
                    ...
                    <div className="w-10 h-3 bg-slate-500/40 rounded-t-full mt-4 border border-slate-400/50"></div>
                </div>
            )
        case 'commerce':
            return (
                <div className="absolute bottom-1 right-8 flex flex-col items-center opacity-90 pointer-events-none">
                    <div className="w-24 h-20 border-2 border-orange-500/40 bg-orange-500/10 rounded-lg flex items-end p-1.5 gap-1.5 relative shadow-[0_0_20px_rgba(249,115,22,0.15)]">
                        <div className="w-4 h-6 bg-orange-400/50 border-t border-orange-300/60 shadow-[0_0_10px_rgba(249,115,22,0.4)]"></div>
                        <div className="w-4 h-10 bg-orange-400/70 border-t border-orange-300/80 shadow-[0_0_10px_rgba(249,115,22,0.6)]"></div>
                        <div className="w-4 h-16 bg-orange-400/90 border-t border-orange-300/100 shadow-[0_0_10px_rgba(249,115,22,0.8)]"></div>
                        <div className="w-4 h-8 bg-orange-400/60 border-t border-orange-300/70 shadow-[0_0_10px_rgba(249,115,22,0.5)]"></div>
                        <div className="absolute top-3 w-[90%] left-[5%] h-[1px] bg-white/40 border-t border-dashed border-orange-400/70"></div>
                    </div>
                    <div className="w-3 h-10 bg-white/20"></div>
                </div>
            )
        case 'rd':
            return (
                <div className="absolute bottom-1 right-12 flex items-end gap-3 opacity-90 pointer-events-none">
                    <div className="w-20 h-8 border-t-2 border-cyan-400/60 bg-cyan-500/10 rounded-t-full relative flex justify-center shadow-[0_0_20px_rgba(34,211,238,0.2)]">
                        ...
                        <div className="absolute bottom-full w-20 h-20 border-2 border-cyan-500/40 rounded-full animate-[spin_15s_linear_infinite_reverse]"></div>
                    </div>
                    <div className="w-10 h-20 border border-white/20 bg-white/10 rounded-md relative overflow-hidden shadow-glass">
                        <div className="absolute top-2 left-1.5 w-7 h-3 bg-cyan-400/50 rounded-sm animate-pulse"></div>
                        <div className="absolute top-6 left-1.5 w-7 h-3 bg-cyan-400/30 rounded-sm"></div>
                    </div>
                </div>
            )
        case 'pr':
            return (
                <div className="absolute bottom-1 right-8 flex flex-col items-center opacity-90 pointer-events-none">
                    ...
                    <div className="w-3 h-12 bg-white/20"></div>
                </div>
            )
        case 'hr':
            return (
                <div className="absolute bottom-1 right-8 flex items-end gap-2 opacity-90 pointer-events-none">
                    <div className="w-12 h-20 border border-rose-500/40 bg-rose-500/10 flex flex-col rounded shadow-[0_0_15px_rgba(244,63,94,0.15)]">
                        ...
                        <div className="flex-1 border-b border-rose-500/30 flex items-center justify-center"><div className="w-4 h-1.5 bg-white/40 rounded-sm"></div></div>
                        <div className="flex-1 flex items-center justify-center"><div className="w-4 h-1.5 bg-white/40 rounded-sm"></div></div>
                    </div>
                    <div className="w-10 h-14 border border-rose-500/40 bg-rose-500/10 flex flex-col rounded shadow-[0_0_15px_rgba(244,63,94,0.1)]">
                        <div className="flex-1 border-b border-rose-500/30 flex items-center justify-center"><div className="w-4 h-1.5 bg-white/40 rounded-sm"></div></div>
                        <div className="flex-1 flex items-center justify-center"><div className="w-4 h-1.5 bg-white/40 rounded-sm"></div></div>
                    </div>
                </div>
        ...
        case 'ops':
            return (
                <div className="absolute bottom-1 right-6 flex items-end gap-2 opacity-90 pointer-events-none">
                    ...
                    <div className="w-14 h-20 border border-blue-400/30 bg-blue-500/10 rounded-t-md shadow-[0_0_15px_rgba(59,130,246,0.1)] flex flex-col justify-evenly px-2">
                        <div className="w-full h-1 bg-blue-400/30 rounded-full"></div>
                        <div className="w-full h-1 bg-blue-400/30 rounded-full"></div>
                        <div className="w-full h-1 bg-blue-400/30 rounded-full animate-pulse"></div>
                    </div>
                </div>
            )
        case 'admin':
            return (
                <div className="absolute bottom-1 right-8 flex items-end gap-1.5 opacity-90 pointer-events-none">
                    <div className="w-10 h-10 border border-yellow-500/40 bg-yellow-500/10 rounded-sm relative shadow-[0_0_15px_rgba(234,179,8,0.15)] flex justify-center">
                        ...
                        <div className="absolute top-2 w-[30%] h-[4px] bg-yellow-400/60 rounded"></div>
                    </div>
                    <div className="flex flex-col gap-1.5">
                        <div className="w-10 h-8 border border-yellow-500/40 bg-yellow-500/10 rounded-sm relative shadow-sm"></div>
                        <div className="w-14 h-10 border border-yellow-500/50 bg-yellow-500/20 rounded-sm relative overflow-hidden shadow-md">
                            <div className="absolute top-0 right-2 w-3 h-full bg-white/10"></div>
                        </div>
                    </div>
                </div>
            )
            ...
            return (
                <div className="absolute bottom-1 right-8 flex items-end gap-2 opacity-90 pointer-events-none">
                    <div className="w-28 h-10 bg-amber-500/10 border border-amber-500/30 rounded-xl flex items-center justify-center relative shadow-[0_0_20px_rgba(245,158,11,0.15)]">
                        <div className="w-[90%] h-[2px] bg-amber-400/50 absolute"></div>
                        <Activity className="text-amber-400 w-8 h-8 z-10 drop-shadow-[0_0_8px_rgba(245,158,11,0.8)] filter" />
                    </div>
                    <div className="w-8 h-20 bg-amber-500/10 border border-amber-500/30 rounded-t-full shadow-[inset_0_0_10px_rgba(245,158,11,0.2)]"></div>
                </div>
            )
        case 'travel':
            return (
                <div className="absolute bottom-1 right-12 flex flex-col items-center opacity-90 pointer-events-none">
                    ...
                    <div className="w-20 h-20 rounded-full border-[3px] border-indigo-500/50 bg-indigo-500/10 relative overflow-hidden flex items-center justify-center shadow-[0_0_25px_rgba(99,102,241,0.2)]">
                        <div className="w-full h-[3px] bg-indigo-400/60 absolute rotate-45 transform origin-center"></div>
                        <div className="w-[3px] h-full bg-indigo-400/60 absolute rotate-45 transform origin-center"></div>
                    ...
                    <div className="w-5 h-8 border-x border-indigo-500/40 bg-indigo-500/20"></div>
                    <div className="w-10 h-3 bg-indigo-500/50 rounded-t-full border border-indigo-400/60 shadow-glow"></div>
                </div>
            )
        default: return null
    }
        ...
        >
            ...
            <AnimatePresence>
                {(isSelected || Math.random() > 0.9) && (
                    ...
                    >
                        {agent.id === 'ceo' && <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-2 h-3 bg-green-400 opacity-90 drop-shadow-[0_0_5px_rgba(74,222,128,0.8)]" style={{ clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' }}></div>}
            ...
            {/* Soft floor shadow specifically for the avatar */}

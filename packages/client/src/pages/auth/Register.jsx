        ...
        <div className="min-h-screen flex items-center justify-center bg-corp-bg p-4 relative overflow-hidden">
            ...
            <div className="corp-card w-full max-w-md relative z-10 p-8">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-2xl font-bold text-white">办理入职</h1>
                    <p className="text-sm text-corp-muted mt-2">注册 Me Corp 管理账户</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            <User size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-corp-muted" />
                            <input
                                type="text" required
